...
const buildAccountItems = (handlers: AdminProfileScreenProps) => [
  {
...
const buildSupportItems = (handlers: AdminProfileScreenProps) => [
  {
    label: "Help Center",
...
export default function AdminProfileScreen(props?: AdminProfileScreenProps) {
  ...
  const handleSettings = handlers.onNavigateToSettings ?? (() => router.push("/admin/settings" as any));
