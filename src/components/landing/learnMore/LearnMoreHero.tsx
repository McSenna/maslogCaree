...
import LearnMoreImagePanel from "./LearnMoreImagePanel";
import SectionLabel from "./SectionLabel";

type LearnMoreHeroProps = {
  wide: boolean;
};

const LearnMoreHero = ({ wide }: LearnMoreHeroProps) => (
  <View
    style={{
  ...
  >
    ...
    <View style={{ width: wide ? 268 : "100%", flexShrink: 0 }}>
      <LearnMoreImagePanel height={wide ? 178 : 132} />
    </View>
  </View>
);
